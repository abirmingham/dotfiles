...
hi Special         cterm=NONE               ctermfg=Brown            ctermbg=NONE             gui=NONE               guifg=Brown            guibg=NONE
hi Identifier      cterm=NONE               ctermfg=DarkCyan         ctermbg=NONE             gui=NONE               guifg=DarkCyan         guibg=NONE
hi Statement       cterm=NONE               ctermfg=Brown            ctermbg=NONE             gui=NONE               guifg=Brown            guibg=NONE
...
hi StatusLine      cterm=NONE               ctermfg=Black            ctermbg=DarkGreen        gui=NONE               guifg=Black            guibg=DarkGreen
hi StatusLineNC    cterm=NONE               ctermfg=Black            ctermbg=DarkBlue         gui=NONE               guifg=White            guibg=DarkBlue

hi clear Visual
hi Visual          cterm=NONE               ctermfg=Black            ctermbg=DarkCyan         gui=NONE               guifg=Black            guibg=DarkCyan
